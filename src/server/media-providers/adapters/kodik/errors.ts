export class KodikConfigurationError extends Error {
  constructor(
    message = "Kodik is disabled: official API configuration is required",
  ) {
    super(message);
    this.name = "KodikConfigurationError";
  }
}
export class KodikPartnerAccessRequiredError extends Error {
  constructor(
    message = "Kodik partner access and an official API contract are required",
  ) {
    super(message);
    this.name = "KodikPartnerAccessRequiredError";
  }
}
