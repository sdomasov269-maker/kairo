...
export type KodikControlMode = (typeof KODIK_CONTROL_MODES)[keyof typeof KODIK_CONTROL_MODES];
export const DEFAULT_KODIK_CONTROL_MODE: KodikControlMode = KODIK_CONTROL_MODES.NATIVE_ONLY;
export function rendersKairoControlBar(mode: KodikControlMode) { return mode === KODIK_CONTROL_MODES.FULL_KAIRO_CONTROLS; }
...
export function shouldHideKodikControls(playing: boolean, menuOpen: boolean, seeking: boolean) {
